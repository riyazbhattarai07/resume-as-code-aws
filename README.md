...
> 📌 **Architecture diagram:** *(Add your diagram here — recommended tools: [CloudSkew](https://www.cloudskew.com/) or [Lucidchart](https://lucidchart.com). Export as PNG and embed with `![Architecture](./docs/architecture.png)`)*
